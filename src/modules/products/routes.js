...
router.patch('/:id', protect, isAdmin, asyncHandler(productController.updateProduct));
router.delete('/:id', protect, isAdmin, asyncHandler(productController.deleteProduct));
