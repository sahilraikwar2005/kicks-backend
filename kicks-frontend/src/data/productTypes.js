...
// (SHOES, TSHIRT, LOWER, SHORTS, SOCKS); SLIDES and CROCS are
...
export const PRODUCT_TYPE_ORDER = ['SHOES', 'SLIDES', 'CROCS', 'TSHIRT', 'LOWER', 'SHORTS', 'SOCKS'];
...
export const PRODUCT_TYPES = {
  ...
  CROCS: { label: 'Crocs / Clogs', title: 'CROCS / CLOGS', image: img('1560343090-f0409e92791a') },
...
export const FOOTWEAR_TYPES = ['SHOES', 'SLIDES', 'CROCS'];
