...
const productBlueprints = [
  { name: 'Nike Air Zoom Pegasus 41', brand: 'Nike', category: 'Running', gender: 'UNISEX', price: 12999, salePrice: 11499, featured: true, newArrival: true, bestSeller: true, tags: ['running', 'comfort', 'road'], shortDescription: 'Cushioned road runner for effortless daily miles.', description: 'The Pegasus 41 brings responsive cushioning and a stable ride for everyday training, commuting, and recovery miles.', seo: { title: 'Nike Air Zoom Pegasus 41 | AJ SPORTS DEMO', description: 'Responsive road running sneaker with soft cushioning and everyday comfort.' } },
  { name: 'Nike Air Force 1 Low', brand: 'Nike', category: 'Lifestyle', gender: 'MEN', price: 8899, salePrice: 7999, featured: true, newArrival: false, bestSeller: true, tags: ['lifestyle', 'classic', 'street'], shortDescription: 'An icon reworked for everyday wear.', description: 'A clean everyday leather sneaker with premium detailing and timeless appeal.', seo: { title: 'Nike Air Force 1 Low | AJ SPORTS DEMO', description: 'Classic sneaker with elevated comfort for street style and daily errands.' } },
  { name: 'Nike Zoom Vomero 5', brand: 'Nike', category: 'Running', gender: 'WOMEN', price: 14999, salePrice: 13499, featured: true, newArrival: true, bestSeller: false, tags: ['running', 'foam', 'daily'], shortDescription: 'Soft-yet-responsive cushioning for long hauls.', description: 'Built for those who want a soft landing and a fast, energized ride across the day.', seo: { title: 'Nike Zoom Vomero 5 | AJ SPORTS DEMO', description: 'High-cushion running shoe that feels soft underfoot and confident underfoot.' } },
  { name: 'Nike Pegasus Trail 4', brand: 'Nike', category: 'Running', gender: 'UNISEX', price: 13999, salePrice: 11999, featured: false, newArrival: true, bestSeller: false, tags: ['trail', 'running', 'grip'], shortDescription: 'Trail-ready grip without sacrificing everyday comfort.', description: 'A versatile trail runner combining responsive cushioning with dependable traction for mixed surfaces.', seo: { title: 'Nike Pegasus Trail 4 | AJ SPORTS DEMO', description: 'Trail-inspired comfort with everyday performance and traction.' } },
  { name: 'Nike Infinity Run 4', brand: 'Nike', category: 'Running', gender: 'UNISEX', price: 15999, salePrice: 14299, featured: false, newArrival: false, bestSeller: true, tags: ['running', 'support', 'daily'], shortDescription: 'Stability-led runner for smooth, effortless mileage.', description: 'The Infinity Run 4 keeps the ride smooth and supportive, making it a dependable choice for speed sessions and daily movement.', seo: { title: 'Nike Infinity Run 4 | AJ SPORTS DEMO', description: 'Long-distance trainer built for smooth transitions and soft support.' } },
  { name: 'Adidas Ultraboost 23', brand: 'Adidas', category: 'Running', gender: 'UNISEX', price: 16999, salePrice: 14999, featured: true, newArrival: true, bestSeller: true, tags: ['boost', 'running', 'comfort'], shortDescription: 'Cushioned daily trainer with premium energy return.', description: 'Ultraboost 23 blends soft comfort and energy return in a sleek silhouette built for everyday miles.', seo: { title: 'Adidas Ultraboost 23 | AJ SPORTS DEMO', description: 'Premium daily-run sneaker with responsive cushioning and everyday comfort.' } },
  { name: 'Adidas Samba OG', brand: 'Adidas', category: 'Lifestyle', gender: 'UNISEX', price: 7999, salePrice: 6999, featured: false, newArrival: false, bestSeller: true, tags: ['classic', 'street', 'lifestyle'], shortDescription: 'A heritage icon with a clean, effortless finish.', description: 'The Samba OG delivers a retro silhouette with modern comfort for everyday wear.', seo: { title: 'Adidas Samba OG | AJ SPORTS DEMO', description: 'Classic adidas silhouette made for everyday comfort and effortless styling.' } },
  { name: 'Adidas Superstar', brand: 'Adidas', category: 'Casual', gender: 'MEN', price: 7499, salePrice: 6499, featured: true, newArrival: false, bestSeller: true, tags: ['casual', 'classic', 'iconic'], shortDescription: 'A clean casual staple with an unmistakable profile.', description: 'The Superstar is a versatile favorite that balances heritage detailing and easy, everyday comfort.', seo: { title: 'Adidas Superstar | AJ SPORTS DEMO', description: 'Heritage casual sneaker built for relaxed, everyday styling.' } },
  { name: 'Adidas Adizero SL', brand: 'Adidas', category: 'Running', gender: 'WOMEN', price: 11999, salePrice: 10999, featured: false, newArrival: true, bestSeller: false, tags: ['speed', 'running', 'lightweight'], shortDescription: 'Lightweight speed feel for quick daily training.', description: 'Built for smooth transitions and light underfoot feel, the Adizero SL keeps sessions efficient and lively.', seo: { title: 'Adidas Adizero SL | AJ SPORTS DEMO', description: 'Lightweight daily trainer with a responsive, easy ride.' } },
  { name: 'Adidas NMD_R1', brand: 'Adidas', category: 'Lifestyle', gender: 'UNISEX', price: 12999, salePrice: 11699, featured: true, newArrival: false, bestSeller: false, tags: ['lifestyle', 'street', 'comfort'], shortDescription: 'A modern sneaker silhouette with layered comfort.', description: 'NMD_R1 blends soft cushioning with a futuristic shape that feels premium and practical.', seo: { title: 'Adidas NMD_R1 | AJ SPORTS DEMO', description: 'Street-ready sneaker with futuristic comfort and premium finish.' } },
  { name: 'Puma Velocity Nitro 3', brand: 'Puma', category: 'Running', gender: 'UNISEX', price: 10999, salePrice: 9999, featured: true, newArrival: true, bestSeller: false, tags: ['nitro', 'running', 'speed'], shortDescription: 'Fast-feeling runner with energised cushioning.', description: 'The Nitrolite setup helps keep each stride cushioned and responsive without adding bulk.', seo: { title: 'Puma Velocity Nitro 3 | AJ SPORTS DEMO', description: 'Responsive running trainer made for smooth speed and comfort.' } },
  { name: 'Puma RS-X', brand: 'Puma', category: 'Lifestyle', gender: 'MEN', price: 8999, salePrice: 7999, featured: true, newArrival: false, bestSeller: true, tags: ['street', 'lifestyle', 'design'], shortDescription: 'Layered cushioning and strong street styling.', description: 'An expressive everyday sneaker with layered comfort and bold accents for city movement.', seo: { title: 'Puma RS-X | AJ SPORTS DEMO', description: 'Chunky street runner with layered comfort and bold, modern styling.' } },
  { name: 'Puma Mx Speed Future', brand: 'Puma', category: 'Training', gender: 'WOMEN', price: 9999, salePrice: 8999, featured: false, newArrival: true, bestSeller: false, tags: ['training', 'power', 'motion'], shortDescription: 'Stable support for rep-heavy training days.', description: 'A hybrid sneaker with traction and structure for intense training sessions and dynamic movement.', seo: { title: 'Puma Mx Speed Future | AJ SPORTS DEMO', description: 'Performance training sneaker built for agility, traction, and power.' } },
  { name: 'New Balance 9060', brand: 'New Balance', category: 'Lifestyle', gender: 'UNISEX', price: 14999, salePrice: 13499, featured: true, newArrival: true, bestSeller: true, tags: ['retro', 'comfort', 'street'], shortDescription: 'Retro-inspired comfort with a reworked modern shape.', description: 'The 9060 merges retro design cues with layered cushioning and a refined everyday finish.', seo: { title: 'New Balance 9060 | AJ SPORTS DEMO', description: 'Retro-inspired sneaker with elevated comfort and layered cushioning.' } },
  { name: 'New Balance 530', brand: 'New Balance', category: 'Casual', gender: 'WOMEN', price: 9999, salePrice: 8799, featured: false, newArrival: false, bestSeller: true, tags: ['casual', 'comfort', 'everyday'], shortDescription: 'Soft everyday comfort with a minimal finish.', description: 'A relaxed silhouette for moving through daily errands with a soft underfoot feel.', seo: { title: 'New Balance 530 | AJ SPORTS DEMO', description: 'Minimal everyday sneaker with plush comfort and soft stability.' } },
  { name: 'New Balance FuelCell Propel', brand: 'New Balance', category: 'Running', gender: 'MEN', price: 12999, salePrice: 11899, featured: false, newArrival: true, bestSeller: false, tags: ['fuelcell', 'running', 'speed'], shortDescription: 'A responsive everyday running trainer with a springy ride.', description: 'Built for runners who want a lively ride without sacrificing support and cushioning.', seo: { title: 'New Balance FuelCell Propel | AJ SPORTS DEMO', description: 'Lively running trainer with springy cushioning and supportive fit.' } },
  { name: 'ASICS Gel-Kayano 30', brand: 'ASICS', category: 'Running', gender: 'UNISEX', price: 16999, salePrice: 15499, featured: true, newArrival: true, bestSeller: true, tags: ['running', 'stability', 'support'], shortDescription: 'Stability-first running comfort with soft cushioning.', description: 'A dependable trainer built for daily mileage, support, and smooth transitions through each step.', seo: { title: 'ASICS Gel-Kayano 30 | AJ SPORTS DEMO', description: 'Stability-focused trainer for everyday support and long-duration comfort.' } },
  { name: 'ASICS Nimbus 26', brand: 'ASICS', category: 'Running', gender: 'WOMEN', price: 15999, salePrice: 14499, featured: true, newArrival: false, bestSeller: true, tags: ['running', 'cushion', 'daily'], shortDescription: 'Soft-cushion ride with a smooth, floating feel.', description: 'A premium daily trainer designed for plush comfort and a smooth stride from start to finish.', seo: { title: 'ASICS Nimbus 26 | AJ SPORTS DEMO', description: 'Soft and smooth running shoe for long daily miles and relaxed comfort.' } },
  { name: 'ASICS GT-1000 13', brand: 'ASICS', category: 'Training', gender: 'MEN', price: 11999, salePrice: 10499, featured: false, newArrival: false, bestSeller: false, tags: ['training', 'support', 'stability'], shortDescription: 'Structured training support with a balanced, stable ride.', description: 'For controlled movement and dependable support, GT-1000 13 keeps training efficient and smooth.', seo: { title: 'ASICS GT-1000 13 | AJ SPORTS DEMO', description: 'Training sneaker with structured support and on-foot stability.' } },
  { name: 'Converse Chuck Taylor All Star', brand: 'Converse', category: 'Casual', gender: 'UNISEX', price: 6499, salePrice: 5699, featured: true, newArrival: false, bestSeller: true, tags: ['classic', 'casual', 'iconic'], shortDescription: 'A timeless classic for daily effortless styling.', description: 'This effortless classic fits right into a relaxed rotation with minimal effort and maximum versatility.', seo: { title: 'Converse Chuck Taylor All Star | AJ SPORTS DEMO', description: 'Heritage casual staple with timeless styling and all-day comfort.' } },
  { name: 'Converse Run Star Hike', brand: 'Converse', category: 'Lifestyle', gender: 'WOMEN', price: 9499, salePrice: 8499, featured: false, newArrival: true, bestSeller: false, tags: ['street', 'lifestyle', 'chunky'], shortDescription: 'Chunky profile with an elevated streetwear finish.', description: 'Built for easy styling and elevated everyday comfort, this silhouette adds volume without sacrificing wearability.', seo: { title: 'Converse Run Star Hike | AJ SPORTS DEMO', description: 'Chunky everyday sneaker with strong attitude and elevated comfort.' } },
  { name: 'Converse Star Player', brand: 'Converse', category: 'Training', gender: 'MEN', price: 7999, salePrice: 7099, featured: false, newArrival: false, bestSeller: false, tags: ['training', 'classic', 'stable'], shortDescription: 'A supportive everyday training essential.', description: 'The Star Player pairs familiar styling with the durable support needed for everyday movement.', seo: { title: 'Converse Star Player | AJ SPORTS DEMO', description: 'Classic training-inspired sneaker for daily movement and light support.' } },
  { name: 'Jordan 1 Retro High', brand: 'Jordan', category: 'Lifestyle', gender: 'MEN', price: 17999, salePrice: 16499, featured: true, newArrival: true, bestSeller: true, tags: ['jordan', 'street', 'heritage'], shortDescription: 'A heritage icon with a modern finish.', description: 'The Jordan 1 Retro High is built around a clean profile, premium leather finish, and everyday streetwear impact.', seo: { title: 'Jordan 1 Retro High | AJ SPORTS DEMO', description: 'Heritage-inspired sneaker with premium finish and streetwear energy.' } },
  { name: 'Jordan 4 Retro', brand: 'Jordan', category: 'Basketball', gender: 'UNISEX', price: 18999, salePrice: 17199, featured: true, newArrival: false, bestSeller: true, tags: ['basketball', 'heritage', 'performance'], shortDescription: 'Court-inspired comfort with heritage detailing.', description: 'A classic basketball silhouette built to blend heritage cues with performance comfort.', seo: { title: 'Jordan 4 Retro | AJ SPORTS DEMO', description: 'Basketball-inspired icon with heritage styling and comfortable support.' } },
  { name: 'Jordan Air M2', brand: 'Jordan', category: 'Basketball', gender: 'WOMEN', price: 13999, salePrice: 12499, featured: false, newArrival: true, bestSeller: false, tags: ['basketball', 'energy', 'daily'], shortDescription: 'A sleek court-inspired option for everyday movement.', description: 'Jordan Air M2 is a modern court-laced silhouette built for movement and impact.', seo: { title: 'Jordan Air M2 | AJ SPORTS DEMO', description: 'Modern court-inspired silhouette with responsive comfort.' } },
  { name: 'Reebok Club C 85', brand: 'Reebok', category: 'Lifestyle', gender: 'UNISEX', price: 7999, salePrice: 6999, featured: false, newArrival: false, bestSeller: true, tags: ['classic', 'everyday', 'minimal'], shortDescription: 'Vintage lines with a polished everyday feel.', description: 'Club C 85 is a refined classic that works effortlessly across casual and everyday looks.', seo: { title: 'Reebok Club C 85 | AJ SPORTS DEMO', description: 'Minimal lifestyle sneaker blending heritage details and easy comfort.' } },
  { name: 'Reebok Nano X4', brand: 'Reebok', category: 'Training', gender: 'MEN', price: 12999, salePrice: 11799, featured: true, newArrival: true, bestSeller: true, tags: ['training', 'performance', 'gym'], shortDescription: 'Training support with durable comfort and easy traction.', description: 'Nano X4 is designed for reps, movement, and daily training with a stable and supportive fit.', seo: { title: 'Reebok Nano X4 | AJ SPORTS DEMO', description: 'Training-ready performance sneaker with stable support and durable comfort.' } },
  { name: 'Reebok Zig Dynamica', brand: 'Reebok', category: 'Running', gender: 'WOMEN', price: 10999, salePrice: 9799, featured: false, newArrival: true, bestSeller: false, tags: ['running', 'support', 'dynamic'], shortDescription: 'Dynamic cushioning for an energetic ride.', description: 'A flexible, energetic runner built for quick strides and comfortable daily movement.', seo: { title: 'Reebok Zig Dynamica | AJ SPORTS DEMO', description: 'Dynamic cushioning runner built for smooth everyday momentum.' } },
];
...
const cmsBlocks = [
  ...
  { key: 'ABOUT', type: 'FEATURED', content: { heading: 'More than just shoes', body: 'AJ SPORTS brings together premium craftsmanship, elevated design, and day-to-day comfort.' }, sortOrder: 2, active: true },
...
const notificationBlueprints = [
  { type: 'WELCOME', title: 'Welcome to AJ SPORTS', message: 'Your new AJ SPORTS account is ready. Start exploring the latest drops.' },
  ...
  { type: 'NEW_ARRIVAL', title: 'New arrivals are live', message: 'Fresh sneakers just landed. Check out the latest AJ SPORTS release.' },
];
